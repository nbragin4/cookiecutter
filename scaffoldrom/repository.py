"""Scaffoldrom repository functions."""
import os
import re

from scaffoldrom.exceptions import RepositoryNotFound
from scaffoldrom.vcs import clone
from scaffoldrom.zipfile import unzip
...
def determine_repo_dir(
    ...
    for repo_candidate in repository_candidates:
        if repository_has_scaffoldrom_json(repo_candidate):
