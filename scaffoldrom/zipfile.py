...
from scaffoldrom.utils import make_sure_path_exists, prompt_and_delete
...
def unzip(
    ...
    This will download the zipfile to the scaffoldrom repository,
    and unpack into a temporary directory.

    :param zip_uri: The URI for the zipfile.
    :param is_url: Is the zip URI a URL or a file?
    :param clone_to_dir: The scaffoldrom repository directory
